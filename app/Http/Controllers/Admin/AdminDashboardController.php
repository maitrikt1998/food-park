...
class AdminDashboardController extends Controller
{
    ...
    {
        $todaysOrders = Order::where('created_at',now()->format('Y-m-d'))->count();
        $todaysEarnings = Order::where('created_at',now()->format('Y-m-d'))->where('order_status','delivered')->sum('grand_total');
        ...
        return $dataTable->render('admin.dashboard.index',compact('todaysOrders','todaysEarnings','thisMonthsOrders','thisMonthsEarnings','thisYearOrders','thisYearEarnings','totalOrders',
        'totalEarnings','totalUsers','totalAdmins','totalProducts','totalBlogs'));
    }
