    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('grand_total', function($query){
                return $query->currency_name.strtoupper($query->grand_total);
            })
            ...
            ->addColumn('action', function($query){
                ...
                $status = "<a href='javascript:;' class='btn btn-warning ml-2 order_status_btn' data-id='".$query->id."' data-toggle='modal' data-target='#order_modal'><i class='fas fa-truck-loading'></i></a>";
