            ...
            <div class="details_size">
                ...
                @foreach ($product->productSize as $productSize)
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="{{ $productSize->id }}" name="product_size"
        ...
        @if ($product->productOption()->exists())
            <div class="details_extra_item">
                ...
                @foreach ($product->productOption as $productOption)
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="product_option[]" data-price="{{ $productOption->price }}" value="{{ $productOption->id }}"
                            id="option-{{ $productOption->id }}">
                        <label class="form-check-label" for="option-{{ $productOption->id }}">
                            option-{{ $productOption->name }} <span>+
...
<script>
    $(document).ready(function(){
        ...
        // function to update total price base on selected option
        function updateTotalPrice(){
            ...
            let selectOptions = $('input[name="product_option[]"]:checked');
