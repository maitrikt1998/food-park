                ...
                <form action="{{ route('address.update', $address->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="fp__check_single_form check_area">
                                <div class="form-check">
                                    <input @checked($address->type === 'home') class="form-check-input" name="type" type="radio" name="flexRadioDefault"
                                        id="flexRadioDefault1" value="home">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        home
                                    </label>
                                ...
                                <div class="form-check">
                                    <input @checked($address->type === 'office')  class="form-check-input" name="type" type="radio" name="flexRadioDefault"
                                        id="flexRadioDefault2" value="office">
                                    <label class="form-check-label" for="flexRadioDefault2">
                                        office
                                    </label>
