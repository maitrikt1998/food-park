                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fp__pro_name">
                                            ...
                                            <p>
                                                @foreach ($product->options?->product_options as $key => $value)
                                                    @if ($key === 'name' || $key === 'price')
                                                        <p>{{ ucfirst($key) }}: {{ is_numeric($value) ? currencyPosition($value) : $value }}</p>
                                                    @endif
                                                @endforeach
                                            </p>
                                        </td>
                                        ...
                                        <td class="fp__pro_select">
                                            <div class="quentity_btn">
                                                ...
                                                <input type="text" placeholder="1"  class="quantity" data-id="{{ $product->rowId }}" value="{{ $product->qty }}" >
                                                <button class="btn btn-success increment"><i class="fal fa-plus"></i></button>
                                            </div>
                                        </td>

                                        <td class="fp__pro_tk">
                                            <h6 class="product_class_total"> {{ currencyPosition(productTotal($product->rowId)) }}</h6>
                                        </td>
...
<script>
    $(document).ready(function() {
        ...
        function createQtyUpdate(rowId, qty, callback){
            $.ajax({
                method: 'post',
